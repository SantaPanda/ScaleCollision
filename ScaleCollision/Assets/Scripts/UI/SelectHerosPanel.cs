...
public class SelectHerosPanel : UIBase
{
    class HeroClass : UIBase
    {
        ...
        private readonly static string SpritePathRoot = "Images/UI/SelectHerosPanel/HeroSprite/{0}";
    ...
    private readonly static string stageShowPath = "Images/UI/SelectHerosPanel/StageShow/{0}";
    private readonly static string portraitPath = "Images/UI/SelectHerosPanel/Portrait/{0}";

    private int SelectHeroId;
    
    public SelectHerosPanel()
    {
    }
